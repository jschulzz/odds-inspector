...
const statMaps = [
  ...
  {
    names: ["Passing Yards", "PassingYards", "Pass Yards", "Pass YDS", "passing_yards"],
  ...
  {
    names: ["RushingTouchdowns", "Rush TDs", "Rushing Touchdowns", "Rushing TDs"],
    stat: PropsStat.RUSHING_TDS
  },
  {
    names: ["Rushing Yards", "RushingYards", "Rush Yards", "Rush YDS", "rushing_yards"],
